...
# 获取IP延迟（60次ping，每次间隔15秒，计算平均延迟）
def get_ping_latency(ip: str, num_pings: int = 60, interval: int = 15) -> tuple[str, float]:
    latencies = []
    for _ in range(num_pings):
        try:
            ...
            time.sleep(interval)  # 每次ping之间的间隔时间为15秒
